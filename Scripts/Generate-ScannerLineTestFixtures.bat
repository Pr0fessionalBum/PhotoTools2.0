...
if "%~1"=="" (
    ...
    powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Invoke-PhotoToolsPerformanceSuite.ps1" -Case All -Iterations 1 -ScannerLineImagesPerCase 40 -InterruptedScannerLineImagesPerCase 12 -Regenerate
) else (
